...
```bash
[studio]
wineroot = "/home/ur_username/.local/share/Steam/compatibilitytools.d/GE-Proton9-22"

[studio.env]
PROTONPATH = "/home/ur_username/.local/share/Steam/compatibilitytools.d/GE-Proton9-22"
GAMEID= "0"
PROTON_VERB = "run"
```
